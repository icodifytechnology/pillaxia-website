...
},
{
  ...
  ctaTo: '#', // ⚠️ TODO: This button currently has no destination — confirm the correct route/URL (e.g. '/app', '/download', '/features')
  angela: true
},
{
  id: 'carehub',
              ...
              <motion.div
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-10 border-b md:border-b-0 md:border-r border-white/10">
                    ...
                    {/* Callout box */}
                    <div className="relative p-4 rounded-xl overflow-hidden bg-white/5 border border-white/10">
                    ...
                    {/* CTA removed from here — moved to below illustration on the right */}
                  </div>

                  {/* Right: illustration + CTA */}
                  <div className="relative flex flex-col items-center justify-between p-8 md:p-10 min-h-[280px] bg-white/5">
                    {/* Illustration */}
                    ...
                    {/* CTA — now lives below the illustration */}
                    <div className="w-full pt-6 mt-2 border-t border-white/10">
                      <Link
                        href={p.ctaTo}
                        className="group w-full inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-xl text-sm font-bold text-white transition-all duration-200 hover:shadow-[0_0_20px_rgba(236,72,153,0.4)] hover:gap-4 bg-gradient-to-r from-[#3b9eff] to-[#ec4899]">
