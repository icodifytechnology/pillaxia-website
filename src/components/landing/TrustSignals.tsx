...
export function TrustSignals() {
  return (
    <section
      aria-label="Trust signals and partner accreditations"
    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 mb-14">
        <span className="block w-14 h-px bg-[#3b9eff]/40" aria-hidden="true" />
        <h2 className="text-[11px] font-bold tracking-[0.22em] uppercase text-[#3b9eff] text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 w-full items-stretch mb-5">
        ...
        <TrustCard>
          <Image
            src="/partner/aibf-accreditation.webp"
            alt="AIBF Business All-Stars 2025 accreditation badge"
            width={130}
            height={56}
        ...
        <TrustCard>
          ...
          <div className="flex items-center justify-center gap-3 mb-5 w-full shrink-0">
            <Image
              src="/partner/intertrade-ireland.webp"
              alt="InterTrade Ireland logo"
              width={90}
              height={56}
              className="h-14 max-w-[90px] object-contain shrink-0"
            />
            <div className="w-px h-7 bg-slate-200 shrink-0" aria-hidden="true" />
            <Image
              src="/partner/hihi-logo.webp"
              alt="Health Innovation Hub Ireland (HIHI) logo"
              width={90}
              height={32}
        ...
        <TrustCard>
          ...
          <div className="flex flex-col items-center justify-center flex-1 w-full mb-5">
            <div className="w-full bg-slate-50 rounded-xl px-4 py-5 flex flex-col items-center gap-2">
              <Image
                src="/partner/new-frontiers-logo.webp"
                alt="Enterprise Ireland New Frontiers programme logo"
                width={200}
                height={48}
        ...
        <TrustCard>
          ...
          <div className="flex flex-col items-center justify-center flex-1 w-full mb-5">
            <div className="w-full bg-slate-50 rounded-xl px-4 py-5 flex flex-col items-center gap-2">
              <Image
                src="/partner/ai-healthcare-logo.webp"
                alt="AI in Healthcare accelerator programme logo"
                width={120}
                height={56}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-0 sm:gap-0 pt-8">
        {taglines.map(({ icon, bg, text }, i) => (
          <div key={text} className="flex items-center">
            ...
            {i < taglines.length - 1 && (
              <div className="hidden sm:block w-px h-5 bg-slate-300 shrink-0" aria-hidden="true" />
            )}
          </div>
        ))}
      </div>
