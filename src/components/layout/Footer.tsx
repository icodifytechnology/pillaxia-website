...
export function Footer() {
  return (
    <footer
      className="bg-[#010d3e] pt-20 pb-10 relative overflow-hidden"
      aria-label="Site footer"
    >
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_20%_50%,_rgba(59,158,255,0.4)_0%,_transparent_50%),_radial-gradient(circle_at_80%_50%,_rgba(236,72,153,0.3)_0%,_transparent_50%)]" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center mb-6" aria-label="Pillaxia home">
              <Image
                src="/logo.png"
                alt="Pillaxia logo"
                width={120}
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mb-6 leading-relaxed">
              Free on iOS and Android. Rated 4.8 by patients.
            </p>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Download Pillaxia on the App Store"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Get Pillaxia on Google Play"
                className="group flex items-center gap-3 bg-white/5 border border-white/10 hover:border-[#3b9eff]/50 text-white rounded-2xl px-4 py-3 transition-all duration-200 hover:shadow-[0_0_15px_rgba(59,158,255,0.2)] hover:-translate-y-0.5"
              >
                <GooglePlayIcon />
                <div className="flex flex-col">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-400 text-sm">
            Headquartered in Louth, Ireland. Made with care for better healthcare.
          </p>
        </div>
      </div>
    </footer>
