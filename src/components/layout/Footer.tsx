        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-400 hover:text-accent-500 hover:shadow-md transition-all">
                <TwitterIcon className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-400 hover:text-accent-500 hover:shadow-md transition-all">
                <LinkedinIcon className="w-5 h-5" />
              </a>
              <a href="mailto:hello@pillaxia.app" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-400 hover:text-accent-500 hover:shadow-md transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={to}>
                  <Link to={to} className="text-slate-600 hover:text-brand-700 transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-slate-400 leading-none mb-0.5">Download on the</span>
                  <span className="text-[14px] font-semibold leading-none">App Store</span>
                </div>
              </a>
              ...
              >
                <GooglePlayIcon />
                <div className="flex flex-col">
                  <span className="text-[10px] text-slate-400 leading-none mb-0.5">Get it on</span>
                  <span className="text-[14px] font-semibold leading-none">Google Play</span>
                </div>
              </a>
            </div>
          </div>
