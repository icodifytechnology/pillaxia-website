        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link
              key={link.name}
              to={link.path}
              className={`text-sm font-medium transition-colors hover:text-[#3b9eff] ${location.pathname === link.path ? 'text-[#3b9eff]' : 'text-slate-300'}`}>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button as={Link} to="/book-demo" size="sm">
              Book a Demo
            </Button>
          </div>
          ...
          className="md:hidden bg-[#010d3e] border-t border-[#3b9eff]/20 overflow-hidden">
            ...
            <Link
              ...
              <div className="flex flex-col gap-3 mt-4">
                ...
                <Button as={Link} to="/book-demo" className="w-full">
                  Book a Demo
                </Button>
              </div>
            </div>
