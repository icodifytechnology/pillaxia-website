...
const loksewaCourses = [
  ...
  },
  {
    ...
    title: 'Assistant',
    sets: 25,
    category: 'Nepal Rastra Bank',
    level: 'Assistant',
  },
  {
    id: 4,
    title: 'Technician/Pra. Sa.',
    sets: 1,
    category: 'Technical',
    level: 'Assistant',
  },
...
export function LoksewaPage() {
  ...
  // Sorting logic could be added here based on sortBy state
  return (
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {['All', 'Officer', 'Assistant'].map((level) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${selectedLevel === level ? 'border-[#d91f22]' : 'border-gray-300 group-hover:border-[#d91f22]'}`}
                      >
                        {selectedLevel === level && (
                      ...
                      />
                      <span
                        className={`text-sm ${selectedLevel === level ? 'text-[#252872] font-medium' : 'text-gray-600 group-hover:text-[#252872]'}`}
                      >
                        {level}
                      </span>
                    </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <AnimatePresence>
                {filteredCourses.map((course, index) => (
                  ...
                  >
                    {/* Left Accent Border */}
                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#d91f22] group-hover:w-2 transition-all duration-300"></div>
                    ...
                    <div className="p-6 pl-8">
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex gap-2">
                          ...
                          <span
                            className={`inline-block px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider rounded-md ${course.level === 'Officer' ? 'bg-indigo-50 text-indigo-600' : 'bg-orange-50 text-orange-600'}`}
                          >
                            {course.level}
                          </span>
                        </div>
                      ...
                      <div className="flex items-center text-gray-500 mb-6 text-sm">
                        ...
                        <span className="font-semibold text-[#252872] mr-1">
                          {course.sets}
                        </span>{' '}
